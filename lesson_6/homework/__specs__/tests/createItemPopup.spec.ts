...
describe('Check events component MyCartPopUp', () => {
    ...
    test('Open popup/fill form/and click create', async () => {
        ...
        const myCartPopUp = await cartPage.openNewCartPopUp();

        reporter.startStep('Check event and open PopUp');
        ...
        await myCartPopUp.fillForm();
        console.log(cartPage.debug());
        await myCartPopUp.clickButtonCreate();
    ...
    test('open popup & close', async () => {
        ...
        await myCartPopUp.clickButtonCloseForm();
